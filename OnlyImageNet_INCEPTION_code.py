...
def preprocessing_image_for_INCEPTION(fin_path,original_class):
    ...
    for i in range(5):
        if(label_inception_v3[0][i][0]==original_class):
        ...
        if entry.is_dir():
            ...
            with os.scandir(new_path) as images:
                for f in images:
                    ...
                    tot_images+=1
                    print(final_path)
                    preprocessing_image_for_INCEPTION(final_path,entry.name)
