...
def preprocessing_image_for_MOBILENET(fin_path,original_class):
    ...
    for i in range(5):
        if(label_mobilenet[0][i][0]==original_class):
        ...
        if entry.is_dir():
            ...
            with os.scandir(new_path) as images:
                for f in images:
                    ...
                    tot_images+=1
                    preprocessing_image_for_MOBILENET(final_path,entry.name)
